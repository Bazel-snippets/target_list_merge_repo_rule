/*
    ...
    <files should_change="yes" platform="windows">
        build\x64\#BUILD_TYPE#\tableau\modules\build_tests\dylib2\CMakeFiles\dylib2_obj.dir\main\Dylib2Pch.cpp*
        build\x64\#BUILD_TYPE#\tableau\modules\build_tests\dylib2\CMakeFiles\dylib2_test_obj.dir\test\Dylib2TestPch.cpp*
    </files>
...
#ifndef TBL_DYLIB2_EXPORT
#    if defined(_WIN32)
#        ifdef TBL_DYLIB2_BUILD
#            define TBL_DYLIB2_EXPORT __declspec(dllexport)
#        else
#            define TBL_DYLIB2_EXPORT __declspec(dllimport)
#        endif
#    else
#        define TBL_DYLIB2_EXPORT __attribute__((visibility("default")))
#    endif
#endif
